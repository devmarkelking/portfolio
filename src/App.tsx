...
export default function App() {
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-500 overflow-visible ${
        theme === "dark"
    ...
    >
      ...
      {/* Footer layout */}
      <footer
        className={`py-12 px-6 border-t font-sans text-xs transition-colors ${
          theme === "dark"
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 font-medium text-center">
            <span>© 2026</span>
            <span>
              Based in {theme === "dark" ? "🌌 Cosmic Space" : "📍 Manila, PH"}
            </span>
          </div>
        </div>
      </footer>
